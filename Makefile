...
up-d: ## Inicia contenedores en background
...
startapp: ## Crea un app de django
	docker-compose -f docker-compose.yml exec web /bin/sh -c "cd backend/apps/;python ../manage.py startapp $(app_name)"
